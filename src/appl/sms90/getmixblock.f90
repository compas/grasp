...
!
!***********************************************************************
!...Translated by Pacific-Sierra Research 77to90  4.3E  18:44:59   1/ 6/07  
...
!      CHARACTER, PARAMETER :: name = 'GETMIXBLOCK'
!-----------------------------------------------
!
...
!***********************************************************************
      ...
      CALL ALLOC (EVAL, NVECTOT, 'EVAL', name) 
      CALL ALLOC (EVEC, NCFTOT*NVECTOT, 'EVEC', name) 
      CALL ALLOC (IVEC, NVECTOT, 'IVEC', name) 
      CALL ALLOC (IATJPO, NVECTOT, 'IATJPO', name ) 
      CALL ALLOC (IASPAR, NVECTOT, 'IASPAR', name) 
