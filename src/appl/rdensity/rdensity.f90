...
!
      WRITE (ISTDE, *)
      WRITE (ISTDE, *) 'RDENSITY PROGRAM'
      WRITE (ISTDE, *) 'Input files:  isodata, name.c, name.w, name.(c)m'
      WRITE (ISTDE, *) 'Output files: name.nw, name.(c)d'
      WRITE (ISTDE, *)
...
!
      CALL RDENSITY_CAL(NAME)
!
!   Print completion message
!
      WRITE (ISTDE, *) 
      WRITE (ISTDE, *) 'RDENSITY: Execution complete.'
!
      STOP
